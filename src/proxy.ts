...
export function proxy(request: NextRequest) {
  ...
  // script-src: izinkan Midtrans sandbox + Trakteer CDN embed + Adsterra ads (profitableratecpmnetwork + subdomains).
  // connect-src: izinkan Adsterra sub-scripts (mereka load pixel/stats dari berbagai domain).
  response.headers.set(
    'Content-Security-Policy',
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://app.sandbox.midtrans.com https://edge-cdn.trakteer.id https://*.profitableratecpmnetwork.com https://profitableratecpmnetwork.com https://*.portalfluently.com https://portalfluently.com https://screwbedriddenheadline.com; style-src 'self' 'unsafe-inline'; img-src 'self' https://image.tmdb.org data: blob:; media-src 'self' https://vidsrc-embed.ru https://vidsrcme.ru https://vidsrc.to https://vidsrc.me blob:; frame-src 'self' https://vidsrc-embed.ru https://vidsrcme.ru https://vidsrc.to https://vidsrc.me https://multiembed.mov https://www.youtube.com https://www.youtube-nocookie.com; connect-src 'self' https://*.supabase.co https://api.themoviedb.org https://app.sandbox.midtrans.com https://edge-cdn.trakteer.id https://*.profitableratecpmnetwork.com https://profitableratecpmnetwork.com https://*.portalfluently.com https://portalfluently.com https://screwbedriddenheadline.com https://*.protrafficinspector.com https://protrafficinspector.com https://*.spendsdetachment.com https://spendsdetachment.com https://*.zoologyfibre.com https://zoologyfibre.com; worker-src 'self' blob:;"
  )
